...
if game:GetService("Players").LocalPlayer:FindFirstChild("PlayerGui") and game:GetService("Players").LocalPlayer.PlayerGui:FindFirstChild("EloHub") then
    game:GetService("Players").LocalPlayer.PlayerGui.EloHub:Destroy()
end

-- Variables
local LocalPlayer = Players.LocalPlayer
local Player = Players.LocalPlayer -- cus i never remember
